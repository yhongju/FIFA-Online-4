...
df_teamcolor_relation = data_io.load_TCL_data()

df_TC_relation_final = RTCPL_crawling.relation_team_color_player_list(df_teamcolor_relation)


# 최종 데이터 출력
# df_teamcolor_club,df_teamcolor_nation,df_teamcolor_reinforce,df_teamcolor_relation,df_teamcolor_special = data_io.load_final_data()